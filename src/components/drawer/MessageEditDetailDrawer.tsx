...
const MessageEditDetailDrawer: React.FC<BlogDetailsDrawerProps> = ({
  open,
  onClose,
  blog,
}) => {
  ...
  return (
    <Drawer
      open={open}
      onClose={onClose}
      title="Các Thông Tin Yêu Cầu Chỉnh Sửa"
      width={1200}
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-center text-gray-500 text-sm">
          {details.category && (
            <span className="bg-indigo-500 text-white py-1 px-3 rounded-full text-sm">
...
export default MessageEditDetailDrawer;
